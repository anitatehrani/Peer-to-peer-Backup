...
def main():
    ...
    parser.add_argument("--config", default="client_server_extension.cfg", help="configuration file")
    ...
    for r in range(10,120,10):
        ...
        for _ in range(0,random_number):
            countte = random.randint(0, 9)
            if (sim.nodes[countte].name=="client"):
                sim.nodes[countte].selfish=True
