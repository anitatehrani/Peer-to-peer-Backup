...
def main():
    ...
    for i in range(10):
        parsing_functions.append((f'peer{i}_upload_speed', parse_size))
        parsing_functions.append((f'peer{i}_download_speed', parse_size))
        parsing_functions.append((f'peer{i}_average_uptime', parse_timespan))
        parsing_functions.append((f'peer{i}_average_downtime', parse_timespan))
        parsing_functions.append((f'peer{i}_average_lifetime', parse_timespan))
        parsing_functions.append((f'peer{i}_average_recover_time', parse_timespan))
        parsing_functions.append((f'peer{i}_arrival_time', parse_timespan))
    ...
    for y in range(len(nodes)):
        sim.nodes[y].id = y
        if(y%2==0):
            sim.nodes[y].average_lifetime *= 20
    print("/////////////////")
    print(nodes)
