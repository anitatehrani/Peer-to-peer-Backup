...
class Node:
    ...
    def __init__(self, name,id, n, k, data_size, storage_size, upload_speed, download_speed, average_uptime, average_downtime, average_lifetime, average_recover_time, arrival_time,selfi):
        self.name = name
        self.id = id
        self.n = n
        self.k = k
