...
class Backup(Simulation):
    ...
    def __init__(self, nodes: List['Node']):
        ...
        self.nodes = nodes
        self.backed_up_blocks_count = [0]* self.n 
...
class Node:
    ...
    def __init__(self, name, n, k, data_size, storage_size, upload_speed, download_speed, average_uptime, average_downtime, average_lifetime, average_recover_time, arrival_time):
        self.name = name
        self.n = n
        self.k = k
...
def main():
    ...
    for y in range(len(nodes)):
        if(y%2==0):
            sim.nodes[y].average_lifetime *= 5
    print("/////////////////")
    print(nodes)
