...
class Node:
    ...
    def __init__(self,i name, n, k, data_size, storage_size, upload_speed, download_speed, average_uptime, average_downtime, average_lifetime, average_recover_time, arrival_time):
        self.name = name
        self.i
        self.n = n
        self.k = k
    ...
    def schedule_next_upload(self, sim: Backup):
        ...
        for peer in sim.nodes:
            ...
            if (peer is not self and peer.online and peer not in remote_owners and peer.current_download is None
                ...
                sim.backed_up_blocks_count[self.]
                return
