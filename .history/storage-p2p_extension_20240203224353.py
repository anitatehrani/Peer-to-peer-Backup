...
def main():
    ...
    for k in range(0,10):
        ...
        count_restore[k][1]=sum(r_values[m][1] for m in range(11))
        count_backup[k][0]=sum(b_values[t][0] for t in range(11))
        count_backup[k][1]=sum(b_values[m][1] for m in range(11))
        # Plot the ratio
