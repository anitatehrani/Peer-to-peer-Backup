...
def main():
    ...
    for _ in range(0,10):
        ...
        #print(f"{counter_var_selfish} selfish nodes were simulated And Have Variant Lifetime.")
    ...
    #lt.plot(range(10, 120, 10), [r[1] for r in count_restore], linestyle='-', color='purple', label='NonVar Restored Blocks')    
