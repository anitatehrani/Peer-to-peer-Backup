...
def main():
    ...
    plt.plot(range(10, 120, 10), [r[0] for r in r_values], linestyle='-', color='blue', label='Var Restored Blocks')    plt.plot(range(10, 120, 10), b_values, linestyle='--', color='red', label='Backed Up Blocks')
