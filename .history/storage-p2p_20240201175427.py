...
def main():
    ...
    average_lifetimes = [parse_timespan(class_config['average_lifetime']) for class_config in config.values()]
    for average_lifetime in average_lifetimes:
        sim = Backup(nodes)
        sim.run(average_lifetime)
